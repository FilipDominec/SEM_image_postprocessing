...
print(ch, cw,typecase_img.shape[1]/len(typecase_str))
...
if size_x > 1000: 
    size_str = '{:<4f}'.format(size_x/1000)[:4] + '×' + '{:<4f}'.format(size_y/1000)[:4] + ' mm'
elif size_x < .1:                                                                     
    size_str = '{:<4f}'.format(size_x*1000)[:4] + '×' + '{:<4f}'.format(size_y*1000)[:4]  + ' nm'
else:                                                                                       
    size_str = '{:<4f}'.format(size_x)[:4]      + '×' + '{:<4f}'.format(size_y)[:4]            + ' μm'
